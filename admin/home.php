...
<div class="second-content">
  ...
  <div class="content">
    <p class="title">A perfect blend of art, flavors, and fun!
      <br> Which workshop would you like to join next?
    </p>
    <p class="caption">Embarked on a <span style="font-weight: bold; color: #e0bb5e;">successful</span> tote bag
      painting <br> extravaganza today, fueled by the delightful <br> combination of coffee and non-coffee, <br>
...
<div class="fourth-content">
  <div class="content">
    ...
    <p class="caption">Have you treated yourself to the <span
        style="font-weight: bold; color: #e0bb5e;">refreshing</span> allure of our Pink Paradise or <br> the tantalizing
      blend of flavors in our Dark Berry? Sip, savor, <br> and discover your new favorites today!</p>
    <a class="view-menu" href="menu.html">VIEW MENU</a>
  </div>
...
<div class="fifth-content">
  ...
  <div class="content">
    ...
    <p class="caption">These <span style="font-weight: bold; color: #e0bb5e;">pastries</span> have been known to cause
      uncrontrollable smiles <br> and sudden cravings. Eat at your own risk!</p>
    <a class="view-menu" href="menu.html">VIEW MENU</a>
  </div>
</div>
